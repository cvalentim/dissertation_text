...
\autor{Caio Dias Valentim}
\autorR{Valentim, Caio}
\orientador{Eduardo Sany Laber}
\orientadorR{Laber, Eduardo}
\coorientador{David Sotelo}
\coorientadorR{Sotelo, David}
\titulo{Estruturas de Dados para Séries Temporais}
\subtitulo{}
\dia{31} \mes{Julho} \ano{2012}
...
\universidade{Pontifícia Universidade Católica}
\uni{PUC-Rio}

\banca{
	\membrodabanca{Guilherme Dias da Fonseca}{Unirio}
	\membrodabanca{Fabio Porto}{PUC-Rio}
	\membrodabanca{Raúl Rentéría}{PUC-Rio}
}
...
\chaves{
	\chave{Estruturas de Dados}
	\chave{Séries Temporais}
	\chave{Algoritmos}
}

\resumo{
	Aqui vai ter um resumo legal.
}
...
\titulouk{
	Data Structures for Temporal Series
}
\resumouk{
	There will be here a great resume in the future.
}
...
\hspace{2cm} {\bf While} $i < j$ e $a_j - a_i \ge d$
